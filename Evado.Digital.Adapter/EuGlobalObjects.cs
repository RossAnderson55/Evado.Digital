...
namespace Evado.Digital.Adapter
{
  ...
  public class EuGlobalObjects
  {
    ...
    private Evado.Digital.Model.EdAdapterSettings _Settings = new Evado.Digital.Model.EdAdapterSettings ( );
    /// <summary>
    /// This property object contains the platform settings object.
    /// </summary>
    public Evado.Digital.Model.EdAdapterSettings Settings
    {
    ...
    Evado.Digital.Adapter.AssemblyAttributes _AssembyAttributes = new Evado.Digital.Adapter.AssemblyAttributes ( );
    ...
    private void loadAdatperSettings ( )
    {
      ...
      // 
      Evado.Digital.Bll.EdAdapterConfig adapterConfig = new Evado.Digital.Bll.EdAdapterConfig ( );

      if ( this.ClassParameters != null )
      {
        adapterConfig = new Evado.Digital.Bll.EdAdapterConfig ( this.ClassParameters );
      }
    ...
    private void LoadStaticEnvironmentalProperties ( )
    {
      ...
      {
        this._PlatformId = (string) ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_PATFORM_ID_KEY ];
      }
    ...
    private void loadSmtpServerProperties ( )
    {
      ...
      {
        if ( ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_SERVER_KEY ] != null )
        {
          this._Settings.SmtpServer = (string) ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_SERVER_KEY ];
        }
        if ( ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_SERVER_PORT_KEY ] != null )
        {
          this._Settings.SmtpServerPort =
            EvStatics.getInteger ( ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_SERVER_PORT_KEY ] );
        }
        if ( ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_USER_KEY ] != null )
        {
          this._Settings.SmtpUserId = (string) ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_USER_KEY ];
        }
        if ( ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_USER_PASSWORD_KEY ] != null )
        {
          this._Settings.SmtpPassword = (string) ConfigurationManager.AppSettings [ Evado.Digital.Model.EvcStatics.CONFIG_SMTP_USER_PASSWORD_KEY ];
        }
      ...
      EvApplicationEvent ApplicationEvent )
    {
      try
      {
        Evado.Digital.Bll.EvApplicationEvents _Bll_ApplicationEvents = new Evado.Digital.Bll.EvApplicationEvents (
