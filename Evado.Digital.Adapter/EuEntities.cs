...
namespace Evado.Digital.Adapter
{
  ...
  public partial class EuEntities : EuClassAdapterBase
  {
    ...
    private Evado.Digital.Bll.EdEntities _Bll_Entities = new Evado.Digital.Bll.EdEntities ( );
          ...
          case Evado.UniForm.Model.EuMethods.Get_Object:
            {
              ...
              switch ( this.Session.StaticPageId )
              {
                case Evado.Digital.Model.EdStaticPageIds.Entity_User_Access_Page:
                  {
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
        ...
        && this.Session.Entity.BookedOutBy != this.Session.UserProfile.CommonName )
      {
        ...
        {
          Evado.UniForm.Model.EuCommand pageCommand = PageObject.addCommand (
    ...
    /// <returns>True:  lock successful</returns>
    //  ------------------------------------------------------------------------------
    public Evado.UniForm.Model.EuAppData unLockRecord_Admin ( )
    {
      // 
      // Test if the record is already locked.
      // 
      ...
      Evado.UniForm.Model.EuCommand PageCommand )
    {
      ...
      //
      if ( this.Session.StaticPageId == Evado.Digital.Model.EdStaticPageIds.Entity_User_Access_Page )
      {
    ...
    /// parameter list.
    /// </summary>
    /// <param name="PageCommand">Evado.UniForm.Model.ClientDataObjectEvado.UniForm.Model.EuCommand object.</param>
      ...
      Evado.UniForm.Model.EuCommand PageCommand )
    {
      try
      {
        ...
        // Update the object.
        // 
        if ( this.Session.PageId == Evado.Digital.Model.EdStaticPageIds.Entity_User_Access_Page.ToString ( ) )
        {
      ...
      Evado.UniForm.Model.EuCommand PageCommand )
    {
      ...
      this.Session.Entity.RecordDate = Evado.Digital.Model.EvcStatics.getDateTime ( stDate );
