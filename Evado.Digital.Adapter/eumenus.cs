...
namespace Evado.Digital.Adapter
{
  ...
  public partial class EuMenus : EuClassAdapterBase
  {
    ...
    public void loadGlobalMenu ( )
    {
      ...
      {
        this.LogDebug ( "loadGlobalMenu exception:  " + Evado.Digital.Model.EvcStatics.getException ( Ex ) );
      }
    ...
    /// <returns>ClientApplicationData object</returns>
    //  ------------------------------------------------------------------------------
    private void getSelectionListGroup ( Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      pageField.AddParameter ( Evado.UniForm.Model.EuFieldParameters.Snd_Cmd_On_Change, 1 );
    ...
    /// <returns> Evado.Digital.Model.EvMenuItem object</returns>
    //  ------------------------------------------------------------------------------
    private Evado.Digital.Model.EvMenuItem getMenuItem ( Guid MenuItemGuid )
    {
      if ( this.AdapterObjects.MenuList.Count > 0 )
      {
        foreach ( EvMenuItem item in this.AdapterObjects.MenuList )
    ...
    /// parameter list.
    /// </summary>
    /// <param name="Command">Evado.UniForm.Model.EuCommand object.</param>
    ...
    /// <returns></returns>
    //  ----------------------------------------------------------------------------------
    private void updateObjectValue ( Evado.UniForm.Model.EuCommand PageCommand )
    {
