...
namespace Evado.Digital.Adapter
{
  ...
  public partial class EuUserRegistration : EuClassAdapterBase
  {
    ...
    public EvEventCodes getAdsCustomerGroup ( )
    {
      ...
      if ( resultGroup == null )
      {
        this.LogValue ( "regsult group null " );
    ...
    public EvEventCodes updateAdUserProfile ( )
    {
      ...
      this.LogValue ( "AdminUserProfile.GivenName: " + this.Session.AdminUserProfile.GivenName );
      this.LogValue ( "AdminUserProfile.FamilyName: " + this.Session.AdminUserProfile.FamilyName );
      this.LogValue ( "AdsCustomerGroup.Name: " + this.Session.AdsCustomerGroup.Name );
