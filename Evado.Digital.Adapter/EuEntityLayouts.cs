...
namespace Evado.Digital.Adapter
{
  ...
  public partial class EuEntityLayouts : EuClassAdapterBase
  {
          ...
          case Evado.Model.UniForm.ApplicationMethods.Create_Object:
            {
              ...
              this.LogDebug ( Evado.Digital.Model.EvcStatics.SerialiseObject<Evado.Model.UniForm.AppData> ( clientDataObject ) );
      ...
      Evado.Model.UniForm.Command PageCommand )
    {
      try
      {
        ...
        clientDataObject.Page.setImageUrl (
          Evado.Model.UniForm.PageImageUrls.Image0_Url,
          EuEntityLayouts.ICON_FORM_DRAFT );

        clientDataObject.Page.setImageUrl (
          Evado.Model.UniForm.PageImageUrls.Image1_Url,
          EuEntityLayouts.ICON_FORM_REVIEWED );

        clientDataObject.Page.setImageUrl (
          Evado.Model.UniForm.PageImageUrls.Image2_Url,
      ...
      Evado.Model.UniForm.Page ClientPage )
    {
      ...
      Evado.Model.UniForm.Field selectionField = new Evado.Model.UniForm.Field ( );
      ...
      Evado.Model.UniForm.Page Page )
    {
      ...
      foreach ( Evado.Digital.Model.EdRecord form in this.AdapterObjects.AllEntityLayouts )
      {
        ...
        groupCommand.AddParameter ( Evado.Model.UniForm.CommandParameters.Short_Title, form.LayoutId );
          ...
          case EdRecordObjectStates.Form_Draft:
            {
              groupCommand.AddParameter (
               Evado.Model.UniForm.CommandParameters.Image_Url,
               EuEntityLayouts.ICON_FORM_DRAFT );
              break;
            }
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      if ( addNewField == true )
      {
        ...
        groupCommand.AddParameter ( Evado.Model.UniForm.CommandParameters.Create_Object, "1" );
