...
namespace Evado.Digital.Adapter
{
  ...
  public class EuSession
  {
    ...
    private DateTime _EventStartDate = Evado.Digital.Model.EvcStatics.CONST_DATE_MIN_RANGE;
    ...
    private DateTime _EventFinishDate = Evado.Digital.Model.EvcStatics.CONST_DATE_MAX_RANGE;
    /// <summary>
   ...
   public List<EvApplicationEvent> ApplicationEventList {get; set; }
    ...
    /// </summary>
    public Evado.UniForm.Model.EuAppData LastPage { get; set; }
    ...
    Evado.Digital.Model.EdUserProfile _UserProfile = new EdUserProfile ( );
    /// <summary>
    /// This property contains the users eClinical user profile.
    /// </summary>
    public Evado.Digital.Model.EdUserProfile UserProfile
    {
    ...
    /// This property contains a list of organisations.
    /// </summary>
    public List<Evado.Digital.Model.EdOrganisation> AdminOrganisationList { get; set; }

    /// <summary>
    /// This property contains the adminstration Organisation
    /// </summary>
    public Evado.Digital.Model.EdOrganisation AdminOrganisation { get; set; }


    Evado.Digital.Model.EdOrganisation _Organisation = new EdOrganisation ( );
    /// <summary>
    /// This property contains the Organisation
    /// </summary>
    public Evado.Digital.Model.EdOrganisation Organisation
    {
      get { return this._Organisation; }
      set { this._Organisation = value; }
    }

    Evado.Digital.Model.EvExportParameters _ExportParameters = new EvExportParameters ( );
    /// <summary>
    /// This property defines the export parameter object.
    /// </summary>
    public Evado.Digital.Model.EvExportParameters ExportParameters
    {
    ...
    /// </summary>
    public Evado.Digital.Model.EdStaticPageIds StaticPageId
    {
      get
      {
        Evado.Digital.Model.EdStaticPageIds pageId = Evado.Digital.Model.EdStaticPageIds.Null;

        if ( EvStatics.tryParseEnumValue<Evado.Digital.Model.EdStaticPageIds> ( this.PageId, out pageId ) == true )
        {
          return pageId;
        }
        return Evado.Digital.Model.EdStaticPageIds.Null;
      }
    }
    //===================================================================================
    /// <summary>
    ...
    /// </summary>
    public List<Evado.Digital.Model.EvBinaryFileMetaData> BinaryFileList { get; set; }

    /// <summary>
    /// This property object contains a binary file metadata objects.
    /// </summary>
    public Evado.Digital.Model.EvBinaryFileMetaData BinaryFile { get; set; }
    /// <summary>
    /// This property object contains a list of versioned file metadata objects for a FileId.
    /// </summary>
    public List<Evado.Digital.Model.EvBinaryFileMetaData> BinaryFileVersionList { get; set; }

    //
    // This property is a list of the eclinical administrator usres list.
    //
    public List<Evado.Digital.Model.EdUserProfile> AdminUserProfileList { get; set; }

    /// <summary>
    /// This property contains the users eClinical user profile used by the admin module.
    /// </summary>
    public Evado.Digital.Model.EdUserProfile AdminUserProfile { get; set; }
