...
namespace Evado.Digital.Adapter
{
  ...
  public class EuReports : EuClassAdapterBase
  {
    ...
    //  ------------------------------------------------------------------------------
    private Evado.UniForm.Model.EuAppData getReports_ListObject (
      Evado.UniForm.Model.EuCommand PageCommand )
    {
      ...
      Evado.UniForm.Model.EuPage Page )
    {
      ...
      try
      {
        ...
        foreach ( EdReport report in this.Session.ReportTemplateList )
        {
          ...
          Evado.UniForm.Model.EuCommand command = pageGroup.addCommand ( stReportTitle,
            EuAdapter.ADAPTER_ID,
            EuAdapterClasses.Reports.ToString ( ),
            Evado.UniForm.Model.EuMethods.Get_Object );

          command.AddParameter ( Evado.UniForm.Model.EuCommandParameters.Page_Id,
             Evado.Digital.Model.EdStaticPageIds.Operational_Report_Page );

          command.AddParameter ( Evado.UniForm.Model.EuCommandParameters.Short_Title,
            report.ReportId );
    ...
    /// <returns>Evado.UniForm.Model.EuAppData object</returns>
    //  ------------------------------------------------------------------------------
    private Evado.UniForm.Model.EuAppData getReport_Object (
      Evado.UniForm.Model.EuCommand PageCommand )
    {
