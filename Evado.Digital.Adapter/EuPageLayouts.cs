...
namespace Evado.Digital.Adapter
{
  ...
  public class EuPageLayouts : EuClassAdapterBase
  {
      ...
      EvClassParameters Settings )
    {
      ...
      this._Bll_PageLayouts = new Evado.Digital.Bll.EdPageLayouts ( this.ClassParameters );
    ...
    private Evado.Digital.Bll.EdPageLayouts _Bll_PageLayouts = new Evado.Digital.Bll.EdPageLayouts ( );
    ...
    /// </summary>
    /// <param name="PageLayout">Evado.Digital.Model.EdPageLayout object.</param>
    /// <returns>Evado.Model.UniForm.AppData object</returns>
    //  ------------------------------------------------------------------------------
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      if ( this.Session.AdminPageLayout.Guid != Evado.Digital.Model.EvcStatics.CONST_NEW_OBJECT_ID )
      {
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      pageGroup.Layout = Evado.Model.UniForm.GroupLayouts.Full_Width;
      pageGroup.SetPageColumnCode ( Evado.Model.UniForm.PageColumnCodes.Body );
    ...
    private Evado.Model.UniForm.AppData createObject ( Evado.Model.UniForm.Command Command )
    {
      ...
      try
      {
        ...
        //
        this.Session.AdminPageLayout = new EdPageLayout ( );
        this.Session.AdminPageLayout.Guid = Evado.Digital.Model.EvcStatics.CONST_NEW_OBJECT_ID;
    ...
    private Evado.Model.UniForm.AppData updateObject ( Evado.Model.UniForm.Command PageCommand )
    {
      try
      {
        ...
        if ( result != EvEventCodes.Ok )
        {
          string StEvent = this._Bll_PageLayouts.Log + " returned error message: " + Evado.Digital.Model.EvcStatics.getEventMessage ( result );
