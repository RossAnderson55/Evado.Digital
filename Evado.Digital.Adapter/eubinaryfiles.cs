...
namespace Evado.Digital.Adapter
{
  ...
  public class EuBinaryFiles : EuClassAdapterBase
  {
    ...
    private Evado.Digital.Bll.EvBinaryFiles _Bll_BinaryFiles = new Evado.Digital.Bll.EvBinaryFiles ( );
    List<EvOption> _MimeList = new List<EvOption> ( );
    private Evado.Digital.Model.EvBinaryFileMetaData _BinaryFile = new EvBinaryFileMetaData ( );
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      newFileCommand.SetBackgroundColour (
        Evado.Model.UniForm.CommandParameters.BG_Default,
        Evado.Model.UniForm.Background_Colours.Purple );
      ...
      Evado.Model.UniForm.Command PageCommand )
    {
      ...
      //
      if ( PageCommand.hasParameter ( EdUserProfile.FieldNames.User_Type.ToString() ) == true )
      {
        value = PageCommand.GetParameter ( EdUserProfile.FieldNames.User_Type.ToString() );
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      groupField.Table.Header = new Evado.Model.UniForm.TableColHeader [ 4 ];
      ...
      String OrgId )
    {
      ...
      try
      {
        ...
        // 
        Evado.Model.UniForm.Group fileListGroup = new Evado.Model.UniForm.Group (
        ...
        fileListGroup.GroupType = Evado.Model.UniForm.GroupTypes.Default;
        ...
        foreach ( EvBinaryFileMetaData binaryFile in binaryFileList )
        {
          ...
          {
            this.LogValue ( " exception: " + Evado.Digital.Model.EvcStatics.getException ( Ex ) );
            bFileCopied = false;
          }
      ...
      EvBinaryFileMetaData BinaryFile )
    {
      ...
      field.Layout = Evado.Model.UniForm.FieldLayoutCodes.Center_Justified;
      ...
      int PixelWidth )
    {
      ...
      if ( BinaryFile.IsImage == true )
      {
        ...
        field.Layout = Evado.Model.UniForm.FieldLayoutCodes.Center_Justified;
        field.AddParameter ( Evado.Model.UniForm.FieldParameterList.Width, PixelWidth );
      ...
      EuAdapterClasses ApplicationClassType )
    {
      ...
      try
      {
        ...
        // retrieved binary files.
        // 
        Evado.Model.UniForm.Group imageFileGroup = new Evado.Model.UniForm.Group (
        ...
        imageFileGroup.GroupType = Evado.Model.UniForm.GroupTypes.Default;
    ...
    public void loadMimeTypes ( )
    {
      ...
      try
      {
        this._MimeList = Evado.Digital.Model.EvcStatics.loadMimeTypes ( this._FileRepositoryPath, "mimetypes.csv" );
