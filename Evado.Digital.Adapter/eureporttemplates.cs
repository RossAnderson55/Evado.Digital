...
namespace Evado.Digital.Adapter
{
  ...
  public class EuReportTemplates : EuClassAdapterBase
  {
      ...
      EvClassParameters Settings )
    {
      ...
      this._Bll_ReportTemplates = new Evado.Digital.Bll.EvReportTemplates ( this.ClassParameters );
    ...
    private Evado.Digital.Bll.EvReportTemplates _Bll_ReportTemplates = new Evado.Digital.Bll.EvReportTemplates ( );
    //
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      //
      if ( this.Session.PageId != Evado.Digital.Model.EdStaticPageIds.Report_Template_Upload.ToString ( ) )
      {
        pageCommand = PageObject.addCommand (
        ...
        pageCommand.AddParameter (
          ...
          Evado.Digital.Model.EdStaticPageIds.Report_Template_Upload );
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      groupCommand.SetPageId ( Evado.Digital.Model.EdStaticPageIds.Report_Template_View );
      ...
      try
      {
        ...
        if ( result != EvEventCodes.Ok )
        {
          string StEvent = this._Bll_ReportTemplates.Log
            + " returned error message: " +  Evado.Digital.Model.EvcStatics.getEventMessage ( result );
      ...
      Evado.UniForm.Model.EuPage Page )
    {
      ...
      // Create the new pageMenuGroup.
      // 
      Evado.UniForm.Model.EuGroup pageGroup = Page.AddGroup (
      ...
      groupCommand.AddParameter ( Evado.UniForm.Model.EuCommandParameters.Page_Id,
         Evado.Digital.Model.EdStaticPageIds.Operational_Report_List );
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      try
      {
        ...
        groupCommand.AddParameter ( Evado.UniForm.Model.EuCommandParameters.Page_Id,
           Evado.Digital.Model.EdStaticPageIds.Report_Template_Page );
        ...
        foreach ( EdReport template in this.Session.ReportDesignTemplateList )
        {
          ...
          groupCommand.AddParameter ( Evado.UniForm.Model.EuCommandParameters.Short_Title,
            template.ReportId );
      ...
      Evado.UniForm.Model.EuAppData ClientDataObject )
    {
      ...
      switch ( pageId )
      {
        case Evado.Digital.Model.EdStaticPageIds.Report_Template_Column_Selection_Page:
          {
            //
    ...
    /// <param name="PageCommand">Evado.UniForm.Model.EuCommand object</param>
    //  -----------------------------------------------------------------------------
    private void updateReportColumnSelection ( Evado.UniForm.Model.EuCommand PageCommand )
    {
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
        ...
        case Evado.Digital.Model.EdStaticPageIds.Report_Template_Column_Selection_Page:
          {
            ...
            pageCommand.SetPageId ( Evado.Digital.Model.EdStaticPageIds.Report_Template_Page );
        ...
        default:
          {
            ...
            pageCommand.SetGuid ( this.Session.ReportTemplate.Guid );
            pageCommand.setCustomMethod ( Evado.UniForm.Model.EuMethods.Get_Object );
            pageCommand.SetPageId ( Evado.Digital.Model.EdStaticPageIds.Report_Template_Column_Selection_Page );
            break;
          }
      }
      ...
      pageCommand.SetGuid ( this.Session.ReportTemplate.Guid );
      pageCommand.setCustomMethod ( Evado.UniForm.Model.EuMethods.Get_Object );
      pageCommand.SetPageId ( Evado.Digital.Model.EdStaticPageIds.Report_Template_Download );
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      //
      if ( this.Session.PageId != Evado.Digital.Model.EdStaticPageIds.Report_Template_Download.ToString ( ) )
      {
        return;
      }
      ...
      xmlReport = Evado.Model.EvStatics.SerialiseXmlObject<EdReport> (
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      DateTime dValue =  Evado.Digital.Model.EvcStatics.CONST_DATE_NULL;
      ...
      Evado.UniForm.Model.EuGroup PageGroup )
    {
      ...
      if ( this.Session.ReportTemplate.Guid == EvStatics.CONST_NEW_OBJECT_ID )
      {
        groupCommand.SetPageId ( Evado.Digital.Model.EdStaticPageIds.Report_Template_Column_Selection_Page );
      }
      else
      {
        groupCommand.SetPageId ( Evado.Digital.Model.EdStaticPageIds.Report_Template_Page );
      }
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      {
        groupField.Table.Header = new Evado.UniForm.Model.EuTableColHeader [ intNumerGroupColumns ];
      }
      ...
      if ( this.Session.ReportTemplate.LayoutTypeId == EdReport.LayoutTypeCode.GroupedTable )
      {
        ...
        groupField.Table.Header [ 4 ] = new Evado.UniForm.Model.EuTableColHeader ( );
      ...
      Evado.UniForm.Model.EuCommand Command )
    {
      ...
      try
      {
        ...
        // Initialise the methods variables and objects.
        //      
        Evado.UniForm.Model.EuAppData data = new Evado.UniForm.Model.EuAppData ( );

        this.Session.ReportSourceList = this._Bll_ReportTemplates.getSourceList ( );

        this.Session.ReportTemplate = new EdReport ( );
        this.Session.ReportTemplate.Guid =  Evado.Digital.Model.EvcStatics.CONST_NEW_OBJECT_ID;
        this.Session.ReportTemplate.LayoutTypeId = EdReport.LayoutTypeCode.FlatTable;

        this.Session.PageId = Evado.Digital.Model.EdStaticPageIds.Report_Template_Page.ToString();
    ...
    /// <returns>Application Data object</returns>
    //  ----------------------------------------------------------------------------------
    private Evado.UniForm.Model.EuAppData updateObject (
      Evado.UniForm.Model.EuCommand PageCommand )
    {
      ...
      try
      {
        ...
        //
        if ( this.Session.ReportTemplate.Guid ==  Evado.Digital.Model.EvcStatics.CONST_NEW_OBJECT_ID )
        {
          this.Session.ReportTemplate.Guid = Guid.Empty;
        }
        ...
        if ( result != EvEventCodes.Ok )
        {
          string StEvent = this._Bll_ReportTemplates.Log + " returned error message: " + Evado.Digital.Model.EvcStatics.getEventMessage ( result );
          this.LogError ( EvEventCodes.Database_Record_Update_Error, StEvent );
      ...
      Evado.UniForm.Model.EuCommand PageCommand )
    {
      ...
      foreach ( Evado.UniForm.Model.EuParameter parameter in PageCommand.Parameters )
      {
        if ( parameter.Name.Contains (  Evado.Digital.Model.EvcStatics.CONST_GUID_IDENTIFIER ) == true
          || parameter.Name.Contains ( Evado.UniForm.Model.EuCommandParameters.Page_Id.ToString ( ) ) == true
          || parameter.Name.Contains ( Evado.UniForm.Model.EuCommandParameters.Custom_Method.ToString ( ) ) == true
          || parameter.Name.Contains ( Evado.UniForm.Model.EuCommandParameters.Short_Title.ToString ( ) ) == true
