...
namespace Evado.Digital.Adapter
{
  ...
  public class EuConversions
  {
    ...
    // ---------------------------------------------------------------------------------
    public static Evado.Model.UniForm.Field convertEvFormfield (  Evado.Digital.Model.EdRecordField FormField )
    {
      // 
      // Initialise the method variables and objects.
      // 
    ...
    /// <returns>List of ClientClientDataObjectFields</returns>
    // ---------------------------------------------------------------------------------
    private static Evado.Model.UniForm.Field generateTableField (  Evado.Digital.Model.EdRecordField FormField )
    {
      // 
      // Initialise the method variables and objects.
      // 
