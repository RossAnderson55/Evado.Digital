...
namespace Evado.Digital.Adapter
{
  ...
  public class EuEntityFields : EuClassAdapterBase
  {
      ...
      Evado.UniForm.Model.EuPage PageObject )
    {
      ...
      //
      optionList = Evado.Digital.Model.EvcStatics.getStringAsOptionList ( "-12:-12;-9:-9;-6:-6;-3:-3;0:0;3:3;6:6;9:9;12:12", true );
        ...
        if ( header.Text != String.Empty )
        {
            ...
            || groupField.Table.Header [ iCol ].TypeId == EvDataTypes.Selection_List )
          {
            groupField.Table.Header [ iCol ].OptionList =
               Evado.Digital.Model.EvcStatics.getStringAsOptionList ( this.Session.EntityField.Table.Header [ iCol ].OptionsOrUnit, true );
          }
