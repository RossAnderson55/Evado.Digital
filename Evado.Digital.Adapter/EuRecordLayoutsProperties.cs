...
namespace Evado.Digital.Adapter
{
  ...
  public partial class EuRecordLayouts : EuClassAdapterBase
  {
    ...
    private Evado.Model.UniForm.EditAccess _DesignAccess = Evado.Model.UniForm.EditAccess.Null;

    private Evado.Model.UniForm.EditAccess _InitialAccess = Evado.Model.UniForm.EditAccess.Null; 
    ...
    //  ------------------------------------------------------------------------------
    private Evado.Model.UniForm.AppData GetRecordProperties_Object (
      ...
      Evado.Model.UniForm.AppData ClientDataObject )
    {
      ...
      {
        this._DesignAccess = Evado.Model.UniForm.EditAccess.Disabled;
      }
      ...
      {
        this._InitialAccess = Evado.Model.UniForm.EditAccess.Disabled;
      }
