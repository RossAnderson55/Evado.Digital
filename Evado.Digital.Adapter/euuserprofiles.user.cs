...
namespace Evado.Digital.Adapter
{
  ...
  public partial class EuUserProfiles : EuClassAdapterBase
  {
    ...
    //  ------------------------------------------------------------------------------
    private Evado.UniForm.Model.EuAppData getObject_MyUserProfile (
    ...
    if ( this.Session.UserProfile.hasManagementAccess == true )
    {
      ...
      //
      optionList = Evado.Digital.Model.EdApplication.getDashBoardList ( false );
     ...
     &&  ( this.Session.UserProfile.hasEndUserRole( this.Session.Record.Design.ReadAccessRoles ) == true ) )
    {
      ...
      // 
      optionList = Evado.Digital.Model.EdApplication.getDashBoardList ( true );
    ...
    //  ----------------------------------------------------------------------------------
    private Evado.UniForm.Model.EuAppData updateUserObject ( Evado.UniForm.Model.EuCommand PageCommand )
    {
    ...
    /// </summary>
    //  ----------------------------------------------------------------------------------
    private EvEventCodes saveUserProfile ( Evado.UniForm.Model.EuCommand PageCommand )
    {
