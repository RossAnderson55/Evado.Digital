...
namespace Evado.Digital.Adapter
{
  ...
  public class EuAnalysis : EuClassAdapterBase
  {
      ...
      EvClassParameters Settings )
    {
      ...
      this._Bll_FormFields = new Evado.Digital.Bll.EdRecordFields ( this.ClassParameters );
      this._Bll_FormRecords = new Evado.Digital.Bll.EdRecords ( this.ClassParameters );
      this._Bll_DataAnalysis = new Evado.Digital.Bll.EvDataAnalysis ( this.ClassParameters );
    ...
    private Evado.Digital.Bll.EdRecords _Bll_FormRecords = new Evado.Digital.Bll.EdRecords ( );

    private Evado.Digital.Bll.EvDataAnalysis _Bll_DataAnalysis = new Evado.Digital.Bll.EvDataAnalysis ( );
    ...
    //  ------------------------------------------------------------------------------
    private Evado.UniForm.Model.AppData getChartObject (
      Evado.UniForm.Model.Command PageCommand )
    {
      ...
      Evado.UniForm.Model.Page Page )
    {
      ...
      groupCommand.AddParameter ( Evado.UniForm.Model.CommandParameters.Page_Id,
         Evado.Digital.Model.EdStaticPageIds.Data_Charting_Page );
      ...
      Evado.UniForm.Model.Page Page )
    {
      ...
      for ( int index = 0; index < 4; index++ )
      {
        ...
        //
        optionList = Evado.Model.EvStatics.getOptionsFromEnum ( typeof ( Evado.Digital.Model.EvChart.AggregationOptions ), true );
      ...
      Evado.UniForm.Model.Page Page )
    {
      ...
      //
      Evado.Digital.Model.EvcStatics.Files.saveFile ( this.UniForm_BinaryFilePath, filename, chartCsvData );
    ...
    /// <returns>Evado.UniForm.Model.AppData object</returns>
    //  ------------------------------------------------------------------------------
    private Evado.UniForm.Model.AppData getRecordQueryObject (
      Evado.UniForm.Model.Command PageCommand )
    {
    ...
    private void getRecordQuery_SelectionLists ( )
    {
      ...
      //
      String parameterValue = String.Empty;
      Evado.Digital.Bll.EdRecordLayouts bllForms = new Evado.Digital.Bll.EdRecordLayouts ( );
      Evado.Digital.Bll.EdRecordFields bllEvFormFields = new Evado.Digital.Bll.EdRecordFields ( );
      Evado.Digital.Bll.EvFormRecordFields trialRecordFields = new Evado.Digital.Bll.EvFormRecordFields ( );
    ...
    private void getRecordQuery_Records ( )
    {
      ...
      //
      String parameterValue = String.Empty;
      Evado.Digital.Bll.EdRecords trialRecords = new Evado.Digital.Bll.EdRecords ( );
      ...
      Evado.UniForm.Model.Page Page )
    {
      ...
      groupCommand.AddParameter ( Evado.UniForm.Model.CommandParameters.Page_Id,
         Evado.Digital.Model.EdStaticPageIds.Record_Query_Page );
      ...
      Evado.UniForm.Model.Page Page )
    {
      ...
      // 
      foreach ( Evado.Digital.Model.EdRecord formRecord in this.Session.AnalysisRecordlist )
      {
        ...
        EuAdapterClasses appObject =
          EuConversions.convertRecordType ( this.Session.Selected_RecordType );
      ...
      Evado.UniForm.Model.Page Page )
    {
      ...
      // Save the chart CSv content to the uniform output directory.
      //
      Evado.Digital.Model.EvcStatics.Files.saveFile ( this.UniForm_BinaryFilePath, filename, sOutput.ToString ( ) );
