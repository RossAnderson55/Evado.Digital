...
namespace Evado.Digital.Model
{
  ...
  /// </summary>
  [Serializable]
  public partial class EdRecordField : Evado.Model.EvHasSetValue<EdRecordField.ClassFieldNames>
  {
    ...
    public const string CONST_CATEGORY_AUTO_FIELD_IDENTIFIER = "AUTO:";
    ...
    public String LinkText
    {
      get
      {
        String stTitle = String.Format (
            Evado.Digital.Model.EdLabels.Form_Field_Draft_List_Command_Title,
            this.FieldId,
            this.Title,
             Evado.Model.EvStatics.getEnumStringValue ( this.TypeId ),
            this.Order.ToString ( "###" ) );

        if ( this.Design.Mandatory == true )
        {
          stTitle += Evado.Digital.Model.EdLabels.Form_Field_Is_Mandatory_List_Label;
        }

        if ( this.Design.HideField == true )
        {
          stTitle += Evado.Digital.Model.EdLabels.Form_Field_Is_Hidden_List_Label;
        }
      ...
      get
      {
        ...
        if ( this.Table != null )
        {
          foreach ( EdRecordTableRow row in this.Table.Rows )
          {
            for ( int i = 0; i < 10; i++ )
            {
              if ( this.Table.Header [ i ].TypeId == Evado.Model.EvDataTypes.Special_Matrix
                || ( this.TypeId == Evado.Model.EvDataTypes.Special_Matrix && i == 0 ) )
              {
                continue;
              }
    ...
    public string ValidationError
    {
      get
      {
        ...
        if ( this.TypeId == Evado.Model.EvDataTypes.Numeric )
        {
    ...
    /// </summary>
    /// <returns>List of Evado.Model.EvOption: a list of data types.</returns>
    /// <remarks>
    /// This method consists of the following steps:
    /// 
    /// 1. Initialize a return list and an option object.
    ...
    /// </remarks>
    //  ---------------------------------------------------------------------------------
    public static List<Evado.Model.EvOption> getDataTypes ( )
    {
      //
      ...
      list.Add ( new Evado.Model.EvOption ( Evado.Model.EvDataTypes.Null.ToString ( ), String.Empty ) );

      //
      // Add the data types for normal forms.
      //
      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Boolean ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Yes_No ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Read_Only_Text ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Text ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Free_Text ) );
      ...
      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Selection_List ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Radio_Button_List ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Check_Box_List ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.External_Selection_List ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.External_RadioButton_List ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.External_CheckBox_List ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Integer_Range ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Float_Range ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Date_Range ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Image ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Http_Link ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Computed_Field ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Horizontal_Radio_Buttons ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Analogue_Scale ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Name ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Address ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Telephone_Number ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Email_Address ) );

      //list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Signature ) );

      //list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.User_Endorsement ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Table ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Special_Matrix ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Special_Subsitute_Data ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.Streamed_Video ) );

      list.Add (  Evado.Model.EvStatics.getOption ( Evado.Model.EvDataTypes.External_Image ) );
