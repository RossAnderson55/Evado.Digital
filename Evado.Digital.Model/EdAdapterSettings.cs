  ...
  public class EdAdapterSettings : Evado.Model.EvParameters
  {
    ...
    public string HelpUrl
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.HelpUrl, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public string HttpReference
    {
      ...
      set
      {
        this.setParameter ( EdAdapterSettings.AdapterFieldNames.Http_Reference,
          Evado.Model.EvDataTypes.Text, value.ToString ( ) );
      }
    }
    ...
    public bool UseHomePageHeaderOnAllPages
    {
      get
      {
        return  Evado.Model.EvStatics.getBool (
      ...
      set
      {
        this.setParameter ( EdAdapterSettings.AdapterFieldNames.Use_Home_Page_Header_On_All_Pages,
          Evado.Model.EvDataTypes.Boolean, value.ToString ( ) );
      }
    }
    ...
    public String StaticQueryFilterOptions
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.Static_Query_Filter_Options, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public String HiddenUserFields
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.Hidden_User_Fields, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public String HiddenOrganisationFields
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.Hidden_Organisation_Fields, Evado.Model.EvDataTypes.Text, value );
      }
    }
    /// <summary>
    /// The method return true if the hidden field is selected.
    ...
    public String UserPrimaryEntity
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.User_Primary_Entity, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public bool CreateOrganisationOnUserRegistration
    {
      get
      {
        return  Evado.Model.EvStatics.getBool ( this.getParameter ( AdapterFieldNames.Create_Organisation_On_User_Registration ) );
      }
      set
      {
        this.setParameter ( AdapterFieldNames.Create_Organisation_On_User_Registration, Evado.Model.EvDataTypes.Boolean, value.ToString ( ) );
      }
    }
    ...
    public String UserCategoryList
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.User_Category_List, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public String OrganisationPrimaryEntity
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.Organisation_Primary_Entity, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public string OrgTypes
    {
      ...
      set
      {
        this.setParameter ( AdapterFieldNames.Org_Types, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    // ----------------------------------------------------------------------------------
    public List<Evado.Model.EvOption> GetOrgTypeList ( bool ForSelectionList )
    {
      //
      ...
      optionList.Add ( new Evado.Model.EvOption ( "Evado", "Evado" ) );
      optionList.Add ( new Evado.Model.EvOption ( "Customer", "Customer" ) );
      ...
      for ( int i = 0; i < arOrgTypes.Length; i++ )
      {
        ...
        optionList.Add ( new Evado.Model.EvOption ( str, str.Replace ( "_", " " ) ) );
      }
    ...
    // ----------------------------------------------------------------------------------
    public List<Evado.Model.EvOption> GetRoleOptionList ( bool ForSelectionList )
    {
      //
      // Initialise the methods variables and objects.
      //
      ...
      //
      optionList.Add ( new Evado.Model.EvOption ( EdUserProfile.CONST_ROLE_ADMINISTRATOR ) );
      optionList.Add ( new Evado.Model.EvOption ( EdUserProfile.CONST_ROLE_MANAGER ) );
      optionList.Add ( new Evado.Model.EvOption ( EdUserProfile.CONST_ROLE_DESIGNER ) );
      optionList.Add ( new Evado.Model.EvOption ( EdUserProfile.CONST_ROLE_STAFF ) );
      optionList.Add ( new Evado.Model.EvOption ( EdUserProfile.CONST_ROLE_CUSTOMER ) );
    ...
    public int DemoAccountExpiryDays
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.DemoAccountExpiryDays, Evado.Model.EvDataTypes.Integer, value.ToString ( "00" ) );
      }
    }
    ...
    public String DemoRegistrationVideoUrl
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.DemoRegistrationVideoUrl, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public string SmtpServer
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.SmtpServer, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public int SmtpServerPort
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.SmtpServerPort, Evado.Model.EvDataTypes.Integer, value.ToString ( ) );
      }
    }
    ...
    public string SmtpUserId
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.SmtpUserId, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public string SmtpPassword
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.SmtpPassword, Evado.Model.EvDataTypes.Text, value );
      }
    }
    ...
    public String EmailAlertTestAddress
    {
      ...
      set
      {
        ...
        this.setParameter ( AdapterFieldNames.EmailAlertTestAddress, Evado.Model.EvDataTypes.Text, value );
      }
    }
      ...
      String Value )
    {
      ...
      switch ( FieldName )
      {
        ...
        case EdAdapterSettings.AdapterFieldNames.State:
          {
            this.setParameter ( AdapterFieldNames.State, Evado.Model.EvDataTypes.Text, Value );
            return;
          }

        case EdAdapterSettings.AdapterFieldNames.Ads_Group:
          {
            this.setParameter ( AdapterFieldNames.Ads_Group, Evado.Model.EvDataTypes.Text, Value );
            return;
          }
        ...
        case EdAdapterSettings.AdapterFieldNames.Enable_Binary_Data:
          {
            this.setParameter ( AdapterFieldNames.Enable_Binary_Data, Evado.Model.EvDataTypes.Boolean, Value );
            return;
          }
        ...
        case EdAdapterSettings.AdapterFieldNames.EnableAdminUpdateOfIssuedObjects:
          {
            this.setParameter ( AdapterFieldNames.EnableAdminUpdateOfIssuedObjects, Evado.Model.EvDataTypes.Boolean, Value );
            return;
          }

        case EdAdapterSettings.AdapterFieldNames.Enable_User_Organisation_Update:
          {
            this.setParameter ( AdapterFieldNames.Enable_User_Organisation_Update, Evado.Model.EvDataTypes.Boolean, Value );
            return;
          }

        case EdAdapterSettings.AdapterFieldNames.Enable_User_Address_Update:
          {
            this.setParameter ( AdapterFieldNames.Enable_User_Address_Update, Evado.Model.EvDataTypes.Boolean, Value );
            return;
          }

        case EdAdapterSettings.AdapterFieldNames.Use_Home_Page_Header_On_All_Pages:
          {
            this.setParameter ( AdapterFieldNames.Use_Home_Page_Header_On_All_Pages, Evado.Model.EvDataTypes.Boolean, Value );
            return;
          }
        ...
        case EdAdapterSettings.AdapterFieldNames.VimeoEmbeddedUrl:
          {
            this.setParameter ( AdapterFieldNames.VimeoEmbeddedUrl, Evado.Model.EvDataTypes.Text, Value );
            return;
          }

        case EdAdapterSettings.AdapterFieldNames.YouTubeEmbeddedUrl:
          {
            this.setParameter ( AdapterFieldNames.YouTubeEmbeddedUrl, Evado.Model.EvDataTypes.Text, Value );
            return;
          }
