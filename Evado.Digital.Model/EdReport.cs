...
namespace Evado.Digital.Model
{
  ...
  public class EdReport
  {
    ...
    */
    ...
    /// </remarks>
    //  --------------------------------------------------------------------------------
    public  Evado.Model.EvEventCodes setValue ( ReportClassFieldNames fieldName, String value )
    {
      //
        ...
        case ReportClassFieldNames.ReportType:
          {
            ...
            if (  Evado.Model.EvStatics.tryParseEnumValue<ReportTypeCode> ( value, out type ) == false )
            {
        ...
        case ReportClassFieldNames.ReportScope:
          {
            ...
            if (  Evado.Model.EvStatics.tryParseEnumValue<ReportScopeTypes> ( value, out type ) == false )
            {
              return  Evado.Model.EvEventCodes.Data_Enumeration_Casting_Error;
            }
        ...
        case ReportClassFieldNames.DataSourceId:
          {
            ...
            if (  Evado.Model.EvStatics.tryParseEnumValue<ReportSourceCode> ( value, out type ) == false )
            {
              return  Evado.Model.EvEventCodes.Data_Enumeration_Casting_Error;
            }
        ...
        case ReportClassFieldNames.LayoutTypeId:
          {
            ...
            if (  Evado.Model.EvStatics.tryParseEnumValue<LayoutTypeCode> ( value, out type ) == false )
            {
              return  Evado.Model.EvEventCodes.Data_Enumeration_Casting_Error;
            }
    ...
    //  ----------------------------------------------------------------------------------
    public static List<Evado.Model.EvOption> getReportLayoutOptionList ( )
    {
      //
    ...
    private const string CONST_NAME_SPACE = "Evado.Digital.Model.EvReport.";
    // ==================================================================================
    /// <summary>
    ...
    {
      this._Log.AppendLine ( Evado.Digital.Model.EvcStatics.CONST_METHOD_START
