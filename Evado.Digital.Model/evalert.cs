...
namespace Evado.Digital.Model
{
  ...
  /// </summary>
  [Serializable]
  public class EvAlert : Evado.Model.EvHasSetValue<EvAlert.AlertFieldNames>
  {
    ...
    /// 
    /// </remarks>
    public static List<Evado.Model.EvOption> getStateList ( )
    {
      //
      ...
      //
      options.Add ( new Evado.Model.EvOption ( EvAlert.AlertStates.Null.ToString ( ), String.Empty ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertStates.Raised ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertStates.Acknowledged ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertStates.Closed ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertStates.Not_Closed ) );
    ...
    public static List<Evado.Model.EvOption> getTypeList ( )
    {
      ...
      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertTypes.Query_Alert ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertTypes.Notiifcation_Alert ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertTypes.SAE_Notification_Alert ) );

      options.Add (  Evado.Model.EvStatics.getOption ( EvAlert.AlertTypes.AE_Notification_Alert ) );
