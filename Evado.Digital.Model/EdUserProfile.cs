...
namespace Evado.Digital.Model
{
  ...
  public class EdUserProfile : Evado.Model.EvUserProfileBase
  {
    ...
    //-----------------------------------------------------------------------------------
    public EdUserProfile ( Evado.Model.EvUserProfileBase BaseUserProfile )
    {
    ...
    //------------------------------------------------------------------------------------
    public void ImportBaseUserProfile ( Evado.Model.EvUserProfileBase BaseUserProfile )
    {
    ...
    /// </remarks>
    //-----------------------------------------------------------------------------------
    public  Evado.Model.EvEventCodes setValue ( FieldNames fieldName, String value )
    {
      ...
      switch ( fieldName )
      {
        ...
        case FieldNames.Expiry_Date:
          {
            this.ExpiryDate =  Evado.Model.EvStatics.getDateTime ( value );
            break;
          }
