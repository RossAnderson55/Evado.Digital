...
namespace Evado.Digital.Model
{
  ...
  /// </summary>
  [Serializable]
  public class EvBinaryFileMetaData : Evado.Model.EvHasSetValue<EvBinaryFileMetaData.ClassFieldNames>
  {
    ...
    DateTime _UploadDate =  Evado.Model.EvStatics.CONST_DATE_NULL;
    /// <summary>
    ...
    DateTime _ReleaseDate =  Evado.Model.EvStatics.CONST_DATE_NULL;
    /// <summary>
    ...
    DateTime _SupersededDate =  Evado.Model.EvStatics.CONST_DATE_NULL;
    /// <summary>
    ...
    /// <returns> Evado.Model.EvEventCodes: true if the value has the proper format</returns>
    /// <remarks>
    ...
    /// </remarks>
    //  --------------------------------------------------------------------------------
    public  Evado.Model.EvEventCodes setValue(EvBinaryFileMetaData.ClassFieldNames fieldName, String value)
    {
      switch (fieldName)
      {
        ...
        case EvBinaryFileMetaData.ClassFieldNames.Encrypted:
          {
            this.FileEncrypted =  Evado.Model.EvStatics.getBool( value );
            break;
          }
