...
namespace Evado.Digital.Model
{
  ...
  public class EdPageLayout : Evado.Model.EvParameters
  {
    ...
    public bool DisplayMainMenu
    {
      ...
      {
        return
          Evado.Model.EvStatics.getBool ( this.getParameter ( EdPageLayout.FieldNames.DisplayMainMenu ) );
      }
      set
      {
    ...
    public Evado.Model.EvOption Option
    {
      get
      {
        if ( this.HomePage == true )
        {
          return new Evado.Model.EvOption ( this.PageId,
            String.Format (
            EdLabels.PageLayout_Link_Text1,
            this.PageId,
            this.Title,
    ...
    public void setValue ( EdPageLayout.FieldNames FieldName, string Value )
    {
      ...
      switch ( FieldName )
      {
        ...
        case EdPageLayout.FieldNames.DefaultHomePage:
          {
            this.HomePage =  Evado.Model.EvStatics.getBool ( Value );
            return;
          }
        ...
        case EdPageLayout.FieldNames.MenuLocation:
          {
            this.MenuLocation =  Evado.Model.EvStatics.parseEnumValue<MenuLocations> ( Value );
            return;
          }
        ...
        case EdPageLayout.FieldNames.LeftColumnWidth:
          {
            this.LeftColumnWidth =  Evado.Model.EvStatics.getShort ( Value );
            return;
          }
        ...
        case EdPageLayout.FieldNames.RightColumnWidth:
          {
            this.RightColumnWidth =  Evado.Model.EvStatics.getShort ( Value );
            return;
          }
        default:
          {
