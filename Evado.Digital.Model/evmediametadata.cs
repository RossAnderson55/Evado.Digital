...
namespace Evado.Digital.Model
{
  ...
  /// </summary>
  [Serializable]
  public class EvMediaMetaData : Evado.Model.EvHasSetValue<EvMediaMetaData.ClassFieldNames>
  {
    ...
    /// </remarks>
    //  --------------------------------------------------------------------------------
    public  Evado.Model.EvEventCodes setValue ( EvMediaMetaData.ClassFieldNames FieldId, String value )
    {
      switch (FieldId)
      {
