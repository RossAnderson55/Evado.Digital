...
namespace Evado.Digital.Model
{
  ...
  /// </summary>
  [Serializable]
  public class EvMenuItem : Evado.Model.EvHasSetValue<EvMenuItem.MenuFieldNames>
  {
    ...
    /// </remarks>
    //  --------------------------------------------------------------------------------
    public  Evado.Model.EvEventCodes setValue ( MenuFieldNames fieldName, String value )
    {
