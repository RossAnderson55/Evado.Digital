...
namespace Evado.Digital.Model
{
  ...
  public class EdRecordFieldDesign
  {
    ...
    Evado.Model.EvDataTypes _TypeId = Evado.Model.EvDataTypes.Null;
    /// <summary>
    ...
    /// <summary>
    /// This OptionList property contains a list of Evado.Model.EvOption object containing the option selections.
          ...
          case Evado.Model.EvDataTypes.Selection_List:
            {
              ...
              {
                foreach ( Evado.Model.EvOption opt in this.OptionList )
                {
                  if (  Evado.Model.EvStatics.isNumber ( opt.Value ) == false )
                  {
                    return false;
                  }
                }
