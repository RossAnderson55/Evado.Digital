...
namespace Evado.Integration.Model
{
  ...
  public class EiData
  {
    ...
    Evado.Integration.Model.EiEventCodes _EventCode = Evado.Integration.Model.EiEventCodes.Ok;
    /// <summary>
    /// This property defines the returned Event code from processing the query or import data.
    /// </summary>
    public Evado.Integration.Model.EiEventCodes EventCode
    {
      set
      {
    ...
    public String getCsvOutput ( )
    {
      ...
      if ( this.ParameterList != null )
      {
        ...
        //
        foreach ( Evado.Integration.Model.EiQueryParameter parameter in this.ParameterList )
        {
      ...
      if ( this.Columns != null )
      {
        foreach ( Evado.Integration.Model.EiColumnParameters parameter in this.Columns )
        {
          value = String.Empty;
      ...
      if ( this.DataRows != null )
      {
        foreach ( Evado.Integration.Model.EiDataRow row in this.DataRows )
        {
          //
    ...
    public String getAsString ( )
    {
      ...
      if ( this.DataRows != null )
      {
        foreach ( Evado.Integration.Model.EiDataRow daraRow in this.DataRows )
        {
...
}//END Namespace Evado.Integration.Model
