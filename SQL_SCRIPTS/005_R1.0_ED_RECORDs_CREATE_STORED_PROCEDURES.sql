...
AS
SELECT     dbo.ED_RECORD_LAYOUT_FIELDS.EDRL_GUID, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_GUID, dbo.ED_RECORD_LAYOUT_FIELDS.EDR_LAYOUT_ID, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.FIELD_ID, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_TYPE_ID, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_ORDER, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_TITLE, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_INSTRUCTIONS, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_HTTP_REFERENCE, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_SECTION_ID, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_OPTIONS, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_SUMMARY_FIELD, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_MANDATORY, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_AI_DATA_POINT, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_ANALYTICS_DATA_POINT, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_HIDDEN, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_EX_SELECTION_LIST_ID, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_EX_SELECTION_LIST_CATEGORY, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_DEFAULT_VALUE, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_UNIT, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_UNIT_SCALING, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_VALIDATION_LOWER_LIMIT, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_VALIDATION_UPPER_LIMIT, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_ALERT_LOWER_LIMIT, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_ALERT_UPPER_LIMIT, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_NORMAL_LOWER_LIMIT, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_NORMAL_UPPER_LIMIT, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_FIELD_CATEGORY, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_ANALOGUE_LEGEND_START, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_ANALOGUE_LEGEND_FINISH, 
                      dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_JAVA_SCRIPT, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_TABLE, dbo.ED_RECORD_LAYOUT_FIELDS.EDRLF_INITIAL_OPTION_LIST, 
...
WHERE (EDR_LAYOUT_ID = @LAYOUT_ID) AND (APPLICATION_ID = @APPLICATION_ID);
