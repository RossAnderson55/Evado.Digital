...
ALTER TABLE ED_ENTITY_LAYOUTS
 ADD 
  EDEL_FILTER_FIELD_0  NVARCHAR(20) NULL,
...
ALTER TABLE ED_ENTITIES
 ADD 
  EDE_FILTER_VALUE_0  NVARCHAR(20) NULL,
  EDE_FILTER_VALUE_1  NVARCHAR(30) NULL,
  EDE_FILTER_VALUE_2  NVARCHAR(30) NULL,
  EDE_FILTER_VALUE_3  NVARCHAR(30) NULL,
  EDE_FILTER_VALUE_4  NVARCHAR(30) NULL
END
GO
