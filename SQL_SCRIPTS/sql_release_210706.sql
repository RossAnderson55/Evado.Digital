...
IF NOT EXISTS( SELECT 1 FROM sys.columns 
          WHERE Name = N'EDELS_PERCENT_WIDTH'
          AND Object_ID = Object_ID(N'ED_ENTITY_SECTIONS' ))
BEGIN
ALTER TABLE ED_ENTITY_SECTIONS
 ADD 
  EDELS_PERCENT_WIDTH INT NULL
END
GO
...
ALTER TABLE ED_RECORD_LAYOUTS
 ADD 
  [EDRL_FIELD_DISPLAY_FORMAT] NVARCHAR(30) NULL
END
GO
...
IF NOT EXISTS( SELECT 1 FROM sys.columns 
          WHERE Name = N'EDRLS_PERCENT_WIDTH'
          AND Object_ID = Object_ID(N'ED_RECORD_SECTIONS' ))
BEGIN
ALTER TABLE ED_RECORD_SECTIONS
 ADD 
  EDRLS_PERCENT_WIDTH INT NULL
END
GO
...
SELECT
  ...
  dbo.ED_RECORD_LAYOUTS.EDRL_PARENT_TYPE,
  dbo.ED_RECORD_LAYOUTS.EDRL_PARENT_ACCESS,
  dbo.ED_RECORD_LAYOUTS.EDRL_PARENT_ENTITIES,
  ...
  dbo.ED_RECORD_LAYOUTS.EDRL_FIELD_DISPLAY_FORMAT,
  dbo.ED_RECORD_LAYOUTS.EDRL_UPDATED_BY_USER_ID,
  dbo.ED_RECORD_LAYOUTS.EDRL_UPDATED_BY,
  dbo.ED_RECORD_LAYOUTS.EDRL_UPDATED_DATE,
  dbo.ED_RECORD_LAYOUTS.EDRL_DELETED,
  dbo.ED_RECORD_LAYOUTS.EDRL_HEADER_FORMAT,
  dbo.ED_RECORD_LAYOUTS.EDRL_FOOTER_FORMAT,
  dbo.ED_RECORD_LAYOUTS.EDRL_FILTER_FIELD_0,
  dbo.ED_RECORD_LAYOUTS.EDRL_FILTER_FIELD_1,
  dbo.ED_RECORD_LAYOUTS.EDRL_FILTER_FIELD_2,
  dbo.ED_RECORD_LAYOUTS.EDRL_FILTER_FIELD_3,
  dbo.ED_RECORD_LAYOUTS.EDRL_FILTER_FIELD_4,
  dbo.ED_RECORDS.EDR_STATE,
  dbo.ED_RECORDS.EDR_RECORD_ID,
  dbo.ED_RECORDS.EDR_SOURCE_ID,
  dbo.ED_RECORDS.EDR_PARENT_ORG_ID,
  dbo.ED_RECORDS.EDR_AUTHOR_USER_ID,
  dbo.ED_RECORDS.EDR_AUTHOR,
  dbo.ED_RECORDS.EDR_PARENT_LAYOUT_ID,
  dbo.ED_RECORDS.EDR_PARENT_GUID,
  dbo.ED_RECORDS.EDR_ENTITY_ACCESS,
  ...
  dbo.ED_RECORDS.EDR_AI_DATA_INDEX,
  dbo.ED_RECORDS.EDR_VISABILITY,
  ...
  dbo.ED_RECORDS.EDR_PARENT_USER_ID,
  dbo.ED_RECORDS.EDR_FILTER_VALUE_0,
  dbo.ED_RECORDS.EDR_FILTER_VALUE_1,
  dbo.ED_RECORDS.EDR_FILTER_VALUE_2,
  dbo.ED_RECORDS.EDR_FILTER_VALUE_3,
  dbo.ED_RECORDS.EDR_FILTER_VALUE_4
FROM   dbo.ED_RECORD_LAYOUTS INNER JOIN
...
FROM         dbo.ED_RECORDS INNER JOIN
  ...
  dbo.ED_RECORD_FIELDS ON dbo.ED_RECORD_VALUES.EDRLF_GUID = dbo.ED_RECORD_FIELDS.EDRLF_GUID INNER JOIN
...
AS
SELECT   
  dbo.ED_RECORD_FIELDS.EDRL_GUID, 
  dbo.ED_RECORD_FIELDS.EDRLF_GUID, 
  dbo.ED_RECORD_FIELDS.EDR_LAYOUT_ID, 
  dbo.ED_RECORD_FIELDS.EDRLF_FIELD_ID, 
  dbo.ED_RECORD_FIELDS.EDRLF_TYPE_ID, 
  dbo.ED_RECORD_FIELDS.EDRLF_ORDER, 
  dbo.ED_RECORD_FIELDS.EDRLF_TITLE, 
...
FROM         dbo.ED_RECORD_VALUES INNER JOIN
                      dbo.ED_RECORD_FIELDS ON dbo.ED_RECORD_VALUES.EDRLF_GUID = dbo.ED_RECORD_FIELDS.EDRLF_GUID
...
SET
  ...
  ,EDR_VISABILITY = @VISABILITY
  ,EDR_ENTITY_ACCESS = @ENTITY_ACCESS
  ,EDR_AI_DATA_INDEX = @AI_DATA_INDEX
  ,EDR_SIGN_OFFS = @SIGN_OFFS
  ,EDR_FILTER_VALUE_0 = @FILTER_VALUE_0
  ,EDR_FILTER_VALUE_1 = @FILTER_VALUE_1
  ,EDR_FILTER_VALUE_2 = @FILTER_VALUE_2
  ,EDR_FILTER_VALUE_3 = @FILTER_VALUE_3
  ,EDR_FILTER_VALUE_4 = @FILTER_VALUE_4
  ,EDR_BOOKED_OUT_USER_ID = ''
  ,EDR_BOOKED_OUT = ''
  ,EDR_UPDATED_BY_USER_ID = @UPDATED_BY_USER_ID
  ,EDR_UPDATED_BY = @UPDATED_BY
