...
SELECT
  ...
  dbo.ED_ENTITIES.ENTITY_ID, 
  dbo.ED_ENTITIES.EDE_RECORD_DATE,
  ...
  dbo.ED_ENTITY_LAYOUTS.EDEL_RECORD_PREFIX,
  dbo.ED_ENTITY_LAYOUTS.EDEL_AUTHOR_ONLY_EDIT_ACCESS,
  dbo.ED_ENTITY_LAYOUTS.EDEL_AUTHOR_ONLY_DRAFT_ACCESS,
...
SELECT     
  ...
  dbo.ED_ENTITIES.EDE_UPDATED_BY_USER_ID, 
  dbo.ED_ENTITIES.EDE_UPDATED_BY, 
  dbo.ED_ENTITY_LAYOUT_FIELDS.EDELF_FIELD_ID, 
...
FROM         dbo.ED_ENTITIES INNER JOIN
  ...
  dbo.ED_ENTITY_LAYOUT_FIELDS ON dbo.ED_ENTITY_VALUES.EDELF_GUID = dbo.ED_ENTITY_LAYOUT_FIELDS.EDELF_GUID INNER JOIN
...
AS
SELECT   
  dbo.ED_ENTITY_LAYOUT_FIELDS.EDEL_GUID, 
  dbo.ED_ENTITY_LAYOUT_FIELDS.EDELF_GUID, 
  dbo.ED_ENTITY_LAYOUT_FIELDS.EDE_LAYOUT_ID, 
...
FROM         dbo.ED_ENTITY_VALUES INNER JOIN
                      dbo.ED_ENTITY_LAYOUT_FIELDS ON dbo.ED_ENTITY_VALUES.EDELF_GUID = dbo.ED_ENTITY_LAYOUT_FIELDS.EDELF_GUID
...
SELECT 	@LAYOUT_GUID = EDEL_GUID, @PREFIX = EDEL_RECORD_PREFIX  
