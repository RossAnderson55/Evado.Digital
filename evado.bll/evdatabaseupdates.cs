...
namespace Evado.Bll
{
  ...
  public class EvDataBaseUpdates : EvBllBase
  {
    ...
    {
      this.ClassNameSpace = "Evado.Bll.Clinical.EvDataBaseUpdates.";
    }
    ...
    // ----------------------------------------------------------------------------------
    public EvDataBaseUpdates ( Evado.Model.Digital.EvClassParameters Settings )
    {
      ...
      this._DalDatabaseUpdates = new Evado.Dal.EvDataBaseUpdates ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.EvDataBaseUpdates _DalDatabaseUpdates = new Evado.Dal.EvDataBaseUpdates();
