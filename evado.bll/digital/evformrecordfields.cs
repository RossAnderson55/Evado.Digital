...
namespace Evado.Bll.Digital
{
  ...
  public class EvFormRecordFields : EvBllBase
  {
    ...
    public EvFormRecordFields ( EvClassParameters Settings )
    {
      ...
      this._Dal_FormRecordFields = new Evado.Dal.Digital.EdRecordValues ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EdRecordValues _Dal_FormRecordFields = new Evado.Dal.Digital.EdRecordValues();
