...
namespace Evado.Bll.Digital
{
  ...
  public class EvBinaryFiles : EvBllBase
  {
    ...
    public EvBinaryFiles ( EvClassParameters Settings )
    {
      ...
      this._DalBinaryFiles = new Evado.Dal.Digital.EvBinaryFiles ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EvBinaryFiles _DalBinaryFiles = new Evado.Dal.Digital.EvBinaryFiles ( );
