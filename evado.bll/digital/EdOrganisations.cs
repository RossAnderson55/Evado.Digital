...
namespace Evado.Bll.Digital
{
  ...
  public class EdOrganisations : EvBllBase
  {
    ...
    public EdOrganisations ( EvClassParameters Settings )
    {
      ...
      this._DalOrganisations = new Evado.Dal.Digital.EdOrganisations ( Settings );
    }
    #endregion

    #region Class variables and properties

    private Evado.Dal.Digital.EdOrganisations _DalOrganisations = new Evado.Dal.Digital.EdOrganisations ( );
