...
namespace Evado.Bll.Digital
{
  ...
  public class EvDataAnalysis : EvBllBase
  {
    ...
    public EvDataAnalysis ( EvClassParameters Settings )
    {
      ...
      this._dalRecordItems = new Evado.Dal.Digital.EdRecordValues ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EdRecordValues _dalRecordItems = new Evado.Dal.Digital.EdRecordValues( );
