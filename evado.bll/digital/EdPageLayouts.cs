...
namespace Evado.Bll.Digital
{
  ...
  public class EdPageLayouts : EvBllBase
  {
    ...
    {
      this.ClassNameSpace = "Evado.Bll.Digital.EdPageLayouts.";
    }
    ...
    public EdPageLayouts ( EvClassParameters Settings )
    {
      ...
      this._dal_SelectionLists = new Evado.Dal.Digital.EdPageLayouts ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EdPageLayouts _dal_SelectionLists = new Evado.Dal.Digital.EdPageLayouts ( );
