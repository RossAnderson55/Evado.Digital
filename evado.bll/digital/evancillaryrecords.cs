...
namespace Evado.Bll.Digital
{
  ...
  public class EvAncillaryRecords : EvBllBase
  {
    ...
    public EvAncillaryRecords ( EvClassParameters Settings )
    {
      ...
      this._dalSubjectRecords = new Evado.Dal.Digital.EvAncillaryRecords ( this.ClassParameter );
    ...
    // 
    private Evado.Dal.Digital.EvAncillaryRecords _dalSubjectRecords = new Evado.Dal.Digital.EvAncillaryRecords ( );
