...
namespace Evado.Bll.Digital
{
  ...
  public class EdRecords : EvBllBase
  {
    ...
    public EdRecords ( EvClassParameters Settings )
    {
      ...
      this._DalRecords = new Evado.Dal.Digital.EdRecords ( Settings );

      this._DalForms = new Evado.Dal.Digital.EdRecordLayouts ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EdRecords _DalRecords = new Evado.Dal.Digital.EdRecords ( );
    private Evado.Dal.Digital.EdRecordLayouts _DalForms = new Evado.Dal.Digital.EdRecordLayouts ( );
