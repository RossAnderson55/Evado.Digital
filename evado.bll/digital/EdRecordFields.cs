...
namespace Evado.Bll.Digital
{
  ...
  public class EdRecordFields : EvBllBase
  {
    ...
    public EdRecordFields ( EvClassParameters Settings )
    {
      ...
      this._DalFormFields = new Evado.Dal.Digital.EdRecordFields ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EdRecordFields _DalFormFields = new Evado.Dal.Digital.EdRecordFields ( );
