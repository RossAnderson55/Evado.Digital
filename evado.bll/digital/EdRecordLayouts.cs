...
namespace Evado.Bll.Digital
{
  ...
  public class EdRecordLayouts : EvBllBase
  {
    ...
    public EdRecordLayouts ( EvClassParameters Settings )
    {
      ...
      this._Dal_RecordLayouts = new Evado.Dal.Digital.EdRecordLayouts ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Digital.EdRecordLayouts _Dal_RecordLayouts = new Evado.Dal.Digital.EdRecordLayouts ( );
