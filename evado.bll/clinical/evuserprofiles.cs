...
namespace Evado.Bll.Clinical
{
  ...
  public class EvUserProfiles : EvBllBase
  {
    ...
    public EvUserProfiles ( EvClassParameters Settings )
    {
      ...
      this._Dal_UserProfiles = new Evado.Dal.Clinical.EvUserProfiles ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Clinical.EvUserProfiles _Dal_UserProfiles = new Evado.Dal.Clinical.EvUserProfiles ( );
