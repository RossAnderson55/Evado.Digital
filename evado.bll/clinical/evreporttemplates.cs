...
namespace Evado.Bll.Clinical
{
  ...
  public class EvReportTemplates : EvBllBase
  {
    ...
    public EvReportTemplates ( EvClassParameters Settings )
    {
      ...
      this._dalReportTemplates = new Evado.Dal.Clinical.EvReportTemplates ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Clinical.EvReportTemplates _dalReportTemplates = new Evado.Dal.Clinical.EvReportTemplates ( );
    ...
    /// <param name="profile">Evado.Model.Digital.EvUserProfile: (Mandatory) the User profile object</param>
