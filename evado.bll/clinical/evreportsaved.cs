...
namespace Evado.Bll.Clinical
{
  ...
  public class EvReportSaved: EvBllBase
  {
    ...
    public EvReportSaved ( EvClassParameters Settings )
    {
      ...
      this._dalReportSaved = new Evado.Dal.Clinical.EvReportSaved ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Clinical.EvReportSaved _dalReportSaved = new Evado.Dal.Clinical.EvReportSaved ( );
