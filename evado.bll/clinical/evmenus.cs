...
namespace Evado.Bll.Clinical
{
  ...
  public class EvMenus : EvBllBase
  {
    ...
    public EvMenus ( )
    {
      this.ClassNameSpace = "Evado.Bll.EvMenus.";
    }
    ...
    public EvMenus ( EvClassParameters Settings )
    {
      ...
      this._dalMenus = new Evado.Dal.Clinical.EvMenus ( Settings );
    }
    #endregion
    ...
    // 
    private Evado.Dal.Clinical.EvMenus _dalMenus = new Evado.Dal.Clinical.EvMenus ( );
