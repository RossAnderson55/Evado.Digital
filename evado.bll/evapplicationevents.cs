...
namespace Evado.Bll
{
  ...
  public class EvApplicationEvents
  {
    ...
    {
      this.ClassNameSpace = "Evado.Bll.Clinical.EvApplicationEvents.";
    }
    ...
    public EvApplicationEvents ( EvClassParameters Settings )
    {
      ...
      {
        this.Settings.LoggingLevel = Evado.Dal.EvStaticSetting.LoggingLevel;
      }

      this._dalApplicationEvents = new Evado.Dal.EvApplicationEvents ( Settings );
    }
    #endregion
    ...
    // 
    private Dal.EvApplicationEvents _dalApplicationEvents = new Evado.Dal.EvApplicationEvents ( );
