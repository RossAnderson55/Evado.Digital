...
namespace Evado.Digital.Dal
{
  ...
  public class EdUserProfiles : EvDalBase
  {
    ...
    {
      this.ClassNameSpace = "Evado.Digital.Dal.Digital.EvUserProfiles.";
    }
    ...
    /// <param name="UserProfile"> Evado.Digital.Model.EvUserProfile: A user profile object</param>
    /// <remarks>
    ...
    /// <returns> Evado.Digital.Model.EvUserProfile: A userprofile object</returns>
    /// <remarks>
    ...
    /// </remarks>
    // -------------------------------------------------------------------------------------
    public  Evado.Digital.Model.EdUserProfile readRow (
      DataRow Row )
    {
      // 
      // Initialise the local variable.
      // 
       Evado.Digital.Model.EdUserProfile profile = new  Evado.Digital.Model.EdUserProfile ( );
    ...
    /// <returns>List of  Evado.Digital.Model.EvUserProfile: A list of UserProfile objects.</returns>
    /// <remarks>
    /// This method consists of following steps. 
    /// 
      ...
      String OrgId )
    {
      ...
      List< Evado.Digital.Model.EdUserProfile> view = new List< Evado.Digital.Model.EdUserProfile> ( );
      ...
      using ( DataTable table = EvSqlMethods.RunQuery ( sqlQueryString, cmdParms ) )
      {
        ...
        for ( int count = 0; count < table.Rows.Count; count++ )
        {
          ...
          DataRow row = table.Rows [ count ];
           ...
           Evado.Digital.Model.EdUserProfile profile = this.readRow ( row );
    ...
    /// <returns> Evado.Digital.Model.EvUserProfile: a user profile object</returns>
    /// <remarks>
    /// This method consists of following steps. 
    /// 
    ...
    /// </remarks>
    // -------------------------------------------------------------------------------------
    public  Evado.Digital.Model.EdUserProfile GetItemByAdsId ( string AdsUserId )
    {
    ...
    /// </remarks>
    // -------------------------------------------------------------------------------------
    private  Evado.Digital.Model.EdUserProfile getUser ( string UserId )
    {
    ...
    /// </summary>
    /// <param name="UserProfile"> Evado.Digital.Model.EvUserProfile: A UserProfile object</param>
       ...
       Evado.Digital.Model.EdUserProfile UserProfile )
    {
      ...
      // Define the local variables.
      // 
       Evado.Digital.Model.EdUserProfile oldUser = new  Evado.Digital.Model.EdUserProfile ( );
       ...
       Evado.Digital.Model.EdUserProfile UserProfile )
    {
      ...
      // Define the local variables.
      // 
       Evado.Digital.Model.EdUserProfile user = this.getUser ( UserProfile.UserId );
    ...
    /// </summary>
    /// <param name="Profile"> Evado.Digital.Model.EvUserProfile: A User Profile object</param>
    ...
    /// </remarks>
    // -------------------------------------------------------------------------------------
    public Evado.Model.EvEventCodes DeleteItem (  Evado.Digital.Model.EdUserProfile Profile )
    {
