...
namespace Evado.Digital.Dal
{
  ...
  public class EdEntities : EvDalBase
  {
    ...
    public EdEntities ( )
    {
      this.ClassNameSpace = "Evado.Digital.Dal.Digital.EdEntities.";
    }
      ...
      EdRecord Entity )
    {
      ...
      CommandParameters [ 7 ].Value = Evado.Model.EvStatics.SerialiseXmlObject<List<EdUserSignoff>> ( Entity.Signoffs );
