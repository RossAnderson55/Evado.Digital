...
namespace Evado.Digital.Dal
{
  ...
  public class EdRecordFields : EvDalBase
  {
    ...
    {
      this.ClassNameSpace = "Evado.Digital.Dal.Digital.EvFormFields.";
    }
    ...
    private void setParameters ( SqlParameter [ ] cmdParms, EdRecordField FormField )
    {
        ...
        || FormField.TypeId == Evado.Model.EvDataTypes.Table )
      {
        ...
        serialisedTableStructure = Evado.Model.EvStatics.SerialiseXmlObject<EdRecordTable> ( FormField.Table );
      }
    ...
    private EdRecordField getRowData ( DataRow Row )
    {
        ...
        || formField.TypeId == Evado.Model.EvDataTypes.Table )
      {
        ...
        {
          formField.Table =  Evado.Model.EvStatics.DeserialiseXmlObject<EdRecordTable> ( xmlTable );
      ...
      //
      if ( formField.ItemValue ==  Evado.Digital.Model.EvcStatics.CONST_NUMERIC_NULL.ToString ( )
