...
namespace Evado.Digital.Bll
{
  ...
  public class EdRecordFields : EvBllBase
  {
    ...
    public EdRecordFields ( EvClassParameters Settings )
    {
      ...
      this._DalFormFields = new  Evado.Digital.Dal.EdRecordFields ( Settings );
    }
    #endregion
    ...
    // 
    private  Evado.Digital.Dal.EdRecordFields _DalFormFields = new  Evado.Digital.Dal.EdRecordFields ( );
