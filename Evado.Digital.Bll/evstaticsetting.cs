  ...
  public class EvStaticSetting
  {
    ...
    public static String EventLogSource
    {
      set
      {
        ...
        Evado.Digital.Dal.EvStaticSetting.EventLogSource = value;
      }
      get
      {
    ...
    public static int LoggingLevel
    {
      ...
      set
      {
        ...
        Evado.Digital.Dal.EvStaticSetting.LoggingLevel = EvStaticSetting._LoggingLevel;
      }
    }
    ...
    public static Guid SiteGuid
    {
      ...
      set
      {
        ...
        Evado.Digital.Dal.EvStaticSetting.SiteGuid = value;
      }
    }
    ...
    public static String ConnectionStringKey
    {
      set
      {
        ...
        Evado.Digital.Dal.EvStaticSetting.ConnectionStringKey = value;
      }
      get
      {
