...
namespace Evado.Digital.Bll
{
  ...
  public class EvFormRecordFields : EvBllBase
  {
    ...
    {
      this.ClassNameSpace = "Evado.Digital.Bll.Clinical.EvFormRecordFields.";
    }
    ...
    public EvFormRecordFields ( EvClassParameters Settings )
    {
      ...
      this._Dal_FormRecordFields = new  Evado.Digital.Dal.EdRecordValues ( Settings );
    }
    #endregion
    ...
    // 
    private  Evado.Digital.Dal.EdRecordValues _Dal_FormRecordFields = new  Evado.Digital.Dal.EdRecordValues();
