...
namespace Evado.Digital.Bll
{
  ...
  public class EvDataChanges: EvBllBase
  {
    ...
    // 
    private  Evado.Digital.Dal.EvDataChanges _dalChanges = new  Evado.Digital.Dal.EvDataChanges ( );
    /// <summary>
      ...
      EvDataChange.DataChangeTableNames RecordTable )
    {
      ...
      // 
      this._DebugLog.AppendLine (  Evado.Digital.Model.EvcStatics.CONST_METHOD_START
        + "Evado.Digital.Bll.Clinical.EvDataChanges.getRecordItemSelectionList " );
      this._DebugLog.AppendLine (  "RecordGuid: " + RecordGuid );
      this._DebugLog.AppendLine (  "RecordTable: " + RecordTable );
