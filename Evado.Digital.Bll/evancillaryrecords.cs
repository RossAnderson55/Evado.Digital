...
namespace Evado.Digital.Bll
{
  ...
  public class EvAncillaryRecords : EvBllBase
  {
    ...
    // 
    private  Evado.Digital.Dal.EvAncillaryRecords _dalSubjectRecords = new  Evado.Digital.Dal.EvAncillaryRecords ( );
    ...
    {
      this._DebugLog.AppendLine ( "Evado.Digital.Bll.AncillaryRecords.getView method. " );
    ...
    {
      this._DebugLog.AppendLine ( "Evado.Digital.Bll.AncillaryRecords.getList method. " );
    ...
    public EvEventCodes lockItem ( EvAncillaryRecord AncillaryRecord )
    {
      ...
      // 
      this._DebugLog.AppendLine ( "Evado.Digital.Bll.AncillaryRecords.lockItem method. " );
      EvEventCodes iReturn = EvEventCodes.Ok;
