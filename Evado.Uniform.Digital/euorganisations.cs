...
namespace Evado.UniForm.Clinical
{
  ...
  public class EuOrganisations : EuClassAdapterBase
  {
    ...
    {
      this.ClassNameSpace = "Evado.UniForm.Clinical.EuOrganisations.";
    }
      ...
      EvClassParameters Settings )
    {
      ...
      this._Bll_Organisations = new Evado.Bll.Clinical.EvOrganisations ( this.ClassParameters );
    ...
    private Evado.Bll.Clinical.EvOrganisations _Bll_Organisations = new Evado.Bll.Clinical.EvOrganisations ( );
      ...
      Evado.Model.UniForm.Command PageCommand )
    {
      try
      {
        ...
        clientDataObject.Title = EvLabels.Organisation_List_Page_Title;
      ...
      catch ( Exception Ex )
      {
        ...
        // 
        this.ErrorMessage = EvLabels.Organisation_List_Error_Message;
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      try
      {
        ...
        Evado.Model.UniForm.Command groupCommand = pageGroup.addCommand (
          EvLabels.Organisation_New_Command_Title,
          EuAdapter.APPLICATION_ID,
          EuAdapterClasses.Organisations.ToString ( ),
      ...
      Evado.Model.UniForm.Command PageCommand )
    {
      ...
      if ( OrgGuid == Guid.Empty )
      {
        ...
        else
        {
          ...
          this.ErrorMessage = EvLabels.Organisation_Guid_Empty_Message;
        }
      ...
      catch ( Exception Ex )
      {
        ...
        // Create the error message to be displayed to the user.
        // 
        this.ErrorMessage = EvLabels.Organisation_Page_Error_Message;
    ...
    private void getDataObject ( Evado.Model.UniForm.AppData ClientDataObject )
    {
      ...
      ClientDataObject.Title = EvLabels.Organisation_Page_Title;
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      if ( PageObject.EditAccess == Evado.Model.UniForm.EditAccess.Enabled )
      {
        ...
        //
        pageCommand = PageObject.addCommand (
          EvLabels.Organisation_Save_Command_Title,
          EuAdapter.APPLICATION_ID,
          EuAdapterClasses.Organisations.ToString ( ),
        ...
        //
        pageCommand = PageObject.addCommand (
          EvLabels.Organisation_Delete_Command_Title,
          EuAdapter.APPLICATION_ID,
          EuAdapterClasses.Organisations.ToString ( ),
          Evado.Model.UniForm.ApplicationMethods.Save_Object );
      ...
      Evado.Model.UniForm.Page PageObject )
    {
      ...
      pageField = pageGroup.createRadioButtonListField (
        ...
        EvLabels.Organisation_Type_Field_Label,
        EvLabels.Organisation_Type_Field_Description,
    ...
    private Evado.Model.UniForm.AppData createObject ( Evado.Model.UniForm.Command Command )
    {
      ...
      try
      {
        ...
        {
          this.LogIllegalAccess (
            "Evado.UniForm.Clinical.Trials.getListObject",
            this.Session.UserProfile );
        ...
        this.Session.AdminOrganisation.CustomerGuid = this.Session.Customer.Guid;
        ...
        if ( result != EvEventCodes.Ok )
        {
          ...
          switch ( result )
          {
            case EvEventCodes.Data_Duplicate_Id_Error:
              {
                this.ErrorMessage =
                  String.Format (
                    EvLabels.Organisation_Duplicate_Error_Message,
            ...
            case EvEventCodes.Identifier_Org_Id_Error:
              {
                this.ErrorMessage = EvLabels.Organisation_Identifier_Empty_Error_Message;
                break;
              }
            default:
              {
                this.ErrorMessage = EvLabels.Organisation_Update_Error_Message;
                break;
              }
          }
          return this.Session.LastPage;
    ...
    private bool updateCheckMandatory ( )
    {
      ...
      if ( this.Session.AdminOrganisation.OrgType  == EvOrganisation.OrganisationTypes.Null)
      {
        ...
        this.ErrorMessage += EvLabels.Organisation_Org_Type_Error_Message;
      ...
      if ( this.Session.AdminOrganisation.Name == String.Empty )
      {
        ...
        this.ErrorMessage += EvLabels.Organisation_Org_Name_Error_Message;
