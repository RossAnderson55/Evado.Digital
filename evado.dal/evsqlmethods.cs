...
namespace Evado.Dal
{
  ...
  public abstract class EvSqlMethods
  {
      ...
      params SqlParameter [ ] CommandParameters )
    {
      ...
      //
      Log = "Evado.Dal.EvSqlMethods.ExecuteReader method";
    ...
    public static DataTable RunQuery ( string SqlQuery )
    {
      ...
      // 
      Log = "Evado.Dal.EvSqlMethods.RunQuery method";
    ...
    public static DataTable RunQuery ( string SqlQuery, params SqlParameter [ ] CommandParameters )
    {
      ...
      if ( _connectionString == String.Empty )
      {
        ...
        Evado.Model.Digital.EvcStatics.WriteToEventLog ( _EventLogSource, stError, EventLogEntryType.Error );
        return queryTable;
      }
    ...
    public static int getInteger ( DataRow Row, string FieldName )
    {
      ...
      if ( Row [ FieldName ] != DBNull.Value )
      {
        ...
        {
          return Evado.Model.Digital.EvcStatics.CONST_INTEGER_NULL;
        }
      }
    ...
    */
    ...
    {
      Log = "Evado.Dal.EvSqlMethods.StoreProcUpdate method";
