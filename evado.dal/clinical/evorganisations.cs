...
namespace Evado.Dal.Clinical
{
  ...
  /// </summary>
  public class EvOrganisations : EvDalBase
  {
      ...
      bool IsCurrent )
    {
      ...
      {
        new SqlParameter ( EvOrganisations.PARM_CUSTOMER_GUID, SqlDbType.UniqueIdentifier),
      ...
      sqlQueryString = SQL_SELECT_QUERY
        + "WHERE ( (" + EvOrganisations.DB_FIELD_CUSTOMER_GUID + " = " + EvOrganisations.PARM_CUSTOMER_GUID + " )\r\n"
        + "     OR (" + EvOrganisations.DB_FIELD_CUSTOMER_GUID + " = " + EvOrganisations.PARM_APPLICATION_GUID + ") )\r\n"
        + " AND (O_Superseded = 0 ) ";
    ...
    public EvOrganisation getItem ( Guid OrgGuid )
    {
      ...
      sqlQueryString = SQL_SELECT_QUERY
        + "WHERE ( (" + EvOrganisations.DB_FIELD_CUSTOMER_GUID + " = " + EvOrganisations.PARM_CUSTOMER_GUID + " )\r\n"
        + "     OR (" + EvOrganisations.DB_FIELD_CUSTOMER_GUID + " = " + EvOrganisations.PARM_APPLICATION_GUID + ") )\r\n"
        + " AND ( O_Guid =" + EvOrganisations.PARM_Guid + " ) ; ";
    ...
    public EvOrganisation getItem ( string OrgId )
    {
      ...
      sqlQueryString = SQL_SELECT_QUERY
        + "WHERE ( (" + EvOrganisations.DB_FIELD_CUSTOMER_GUID + " = " + EvOrganisations.PARM_CUSTOMER_GUID + " )\r\n"
        + "     OR (" + EvOrganisations.DB_FIELD_CUSTOMER_GUID + " = " + EvOrganisations.PARM_APPLICATION_GUID + ") )\r\n"
        + " AND ( OrgId =" + EvOrganisations.PARM_OrgId + " ) ; ";
