...
namespace Evado.Dal.Digital
{
  ...
  /// </summary>
  public class EdRecordEntities : EvDalBase
  {
    ...
    private Evado.Model.Digital.EdRecordEntity getRowData ( DataRow Row )
    {
      ...
      //
      entity.RecordLayoutGuid = EvSqlMethods.getGuid ( Row, EdRecordEntities.DB_RECORD_LAYOUT_GUID );
      entity.RecordGuid = EvSqlMethods.getGuid ( Row, EdRecordEntities.DB_RECORD_GUID );
      entity.EntityGuid = EvSqlMethods.getGuid ( Row, EdRecordEntities.DB_ENTITY_GUID );
      entity.EntityLayoutId = EvSqlMethods.getString ( Row, EdRecordEntities.DB_ENTITY_LAYOUT_ID );
      entity.EntityTitle = EvSqlMethods.getString ( Row, EdRecordEntities.DB_ENTITY_TITLE );
    ...
    public List<EdRecordEntity> getEntityList ( EdRecord Record )
    {
      ...
      {
        new SqlParameter( EdRecordEntities.PARM_RECORD_LAYOUT_GUID, SqlDbType.UniqueIdentifier),
        new SqlParameter( EdRecordEntities.PARM_RECORD_GUID, SqlDbType.UniqueIdentifier),
      };
      ...
      {
        _sqlQueryString = _sqlQueryView + " WHERE ( " + EdRecordEntities.DB_RECORD_LAYOUT_GUID + "  = " + EdRecordEntities.PARM_RECORD_LAYOUT_GUID + ") "
          + "ORDER BY " + EdRecordEntities.DB_ENTITY_LAYOUT_ID + "; ";
      }
      else
      {
        _sqlQueryString = _sqlQueryView + " WHERE ( " + EdRecordEntities.DB_RECORD_GUID + "  = " + EdRecordEntities.PARM_RECORD_GUID + ") "
          + "ORDER BY " + EdRecordEntities.DB_ENTITY_LAYOUT_ID + "; ";
      }
    ...
    public EvEventCodes UpdateItem ( EdRecord Record )
    {
      ...
      if ( Record.Guid == Guid.Empty )
      {
        sbSQL_AddQuery.AppendLine ( "DELETE FROM ED_ENTITY_RECORD_JOIN "
          + " WHERE ( " + EdRecordEntities.DB_RECORD_LAYOUT_GUID + "  = '" + Record.LayoutGuid + "') " ); ;
      }
      else
      {
        sbSQL_AddQuery.AppendLine ( "DELETE FROM ED_ENTITY_RECORD_JOIN "
        + "WHERE " + EdRecordEntities.DB_RECORD_GUID + "= '" + Record.Guid + "';  \r\n\r\n" );
      }
      ...
      for ( int count = 0; count < Record.Entities.Count; count++ )
      {
        ...
        SqlParameter prm = new SqlParameter ( EdRecordEntities.PARM_RECORD_LAYOUT_GUID + "_" + count, SqlDbType.UniqueIdentifier );
        prm.Value = Record.LayoutGuid;
        parmList.Add ( prm );

        prm = new SqlParameter ( EdRecordEntities.PARM_RECORD_GUID + "_" + count, SqlDbType.UniqueIdentifier );
        prm.Value = Record.Guid;
        parmList.Add ( prm );

        prm = new SqlParameter ( EdRecordEntities.PARM_ENTITY_GUID + "_" + count, SqlDbType.UniqueIdentifier );
        prm.Value = entity.EntityGuid;
        parmList.Add ( prm );

        prm = new SqlParameter ( EdRecordEntities.PARM_ENTITY_LAYOUT_ID + "_" + count, SqlDbType.VarChar, 20 );
        prm.Value = entity.EntityLayoutId;
        parmList.Add ( prm );

        prm = new SqlParameter ( EdRecordEntities.PARM_ENTITY_TITLE + "_" + count, SqlDbType.VarChar, 100 );
        ...
        + "(" + EdRecordEntities.PARM_RECORD_LAYOUT_GUID
        + ", " + EdRecordEntities.PARM_RECORD_GUID
        + ", " + EdRecordEntities.PARM_ENTITY_GUID
        + ", " + EdRecordEntities.PARM_ENTITY_LAYOUT_ID
        + ", " + EdRecordEntities.PARM_ENTITY_TITLE
        + "  )  \r\n"
        + "VALUES ("
        + ", " + EdRecordEntities.PARM_RECORD_LAYOUT_GUID + "_" + count
        + ", " + EdRecordEntities.DB_RECORD_GUID + "_" + count
        + ", " + EdRecordEntities.DB_ENTITY_GUID + "_" + count
        + ", " + EdRecordEntities.DB_ENTITY_LAYOUT_ID + "_" + count
        + ", " + EdRecordEntities.DB_ENTITY_TITLE + "_" + count + " );  \r\n" );
      }
