...
namespace Evado.Model.Digital
{
  ...
  public class EvOrganisation
  {
    ...
    /// <summary>
    /// This property indicates whether an organization is a test site.
    /// </summary>
    public bool IstTestSite
    {
      get
      {
        return EvcStatics.isTestSite ( this._OrgId );
      }
    }
      ...
      get
      {
        ...
        if ( this._OrgType != OrganisationTypes.Null )
        {
          stLinkText += EvLabels.Space_Coma
            + EvLabels.Organisation_Type_Label
            + EvcStatics.Enumerations.enumValueToString ( this._OrgType );
        }

        if ( this._State != OrganisationStates.Null )
        {
          stLinkText += EvLabels.Space_Coma
